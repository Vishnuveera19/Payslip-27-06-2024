...
const Medical = ({ employeeDetails }) => {
  const [bills, setBills] = useState([{ dateofservice: "", hospital: "", amount: "", base64File: "" }]);
  ...
  const handleFileSelect = (event, index) => {
    ...
    reader.onloadend = () => {
      ...
      setBills(bills.map((bill, i) => (i === index ? { ...bill, base64File: base64String } : bill)));
    };
  ...
  const addNewBillRow = () => {
    setBills([...bills, { dateofservice: "", hospital: "", amount: "", base64File: "" }]);
  };
  ...
  return (
    <div style={{ textAlign: 'center', margin: '20px' }}>
      ...
      <Grid container justifyContent="center">
        <Grid item>
          <TableContainer component={Paper} style={{ width: 'fit-content', marginRight: '40px', marginTop: '10px' }}>
            <Table>
              <TableBody>
                <TableRow>
                ...
                <TableRow>
                  <TableCell style={{ padding: '8px', width: '200px' }}>Employee Code: {employeedetails ? employeedetails.employeeCode : 'No Name Available'}</TableCell>
                </TableRow>
                <TableRow>
                ...
                <TableRow key={index}>
                  <TableCell>
                    <FormControl fullWidth>
                      <TextField
                        ...
                        onChange={(e) => setBills(bills.map((b, i) => i === index ? { ...b, dateofservice: e.target.value } : b))}
                      />
                    </FormControl>
                  </TableCell>
                  <TableCell>
                    <FormControl fullWidth>
                      <TextField
                        ...
                        required
                        value={bill.hospital}
                        onChange={(e) => setBills(bills.map((b, i) => i === index ? { ...b, hospital: e.target.value } : b))}
                      />
                    </FormControl>
                  </TableCell>
                  <TableCell>
                    <FormControl fullWidth>
                      <TextField
                        ...
                        required
                        value={bill.amount}
                        onChange={(e) => setBills(bills.map((b, i) => i === index ? { ...b, amount: e.target.value } : b))}
                      />
                    </FormControl>
                  </TableCell>
                  <TableCell></TableCell>
                  <TableCell>
                    ...
                    <div style={{ display: 'flex', marginTop: '10px' }}>
                      <Button variant='contained' size='small' onClick={() => handlesubmit(index)}>SUBMIT</Button>
                      <Button variant='outlined' size='small' style={{ marginLeft: '10px' }} onClick={addNewBillRow}>Add another bill</Button>
                    </div>
                  </TableCell>
                </TableRow>
              ))}
