...
import { REPORT } from '../../serverconfiguration/controllers';
    ...
    return (
        <TableContainer component={Paper}>
            <Table>
                <TableHead>
                    <TableRow>
                        <TableCell style={{backgroundColor:'blue', color: 'white'}}>Employee ID</TableCell>
                        <TableCell style={{backgroundColor:'blue', color: 'white'}}>Employee Code</TableCell>
                        <TableCell style={{backgroundColor:'blue', color: 'white'}}>Employee Full Name</TableCell>
                        <TableCell style={{backgroundColor:'blue', color: 'white'}}>Medical Bill</TableCell>
                        <TableCell style={{backgroundColor:'blue', color: 'white'}}>Date of Service</TableCell>
                        <TableCell style={{backgroundColor:'blue', color: 'white'}}>Hospital Name</TableCell>
                        <TableCell style={{backgroundColor:'blue', color: 'white'}}>Amount</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {medicalslip.length > 0 ? (
                                    ...
                                    {medical.Medicalbills ? (
                                        selectedImageIndex === index ? (
                                            <div>
                                                ...
                                                />
                                                <Button variant = 'contained'style={{textAlign: 'center', marginLeft: '480px'}} onClick={() => handleImageClick(index)}>Back</Button>
                                            </div>
                                        ) : (
                                            <Button variant = "outlined" onClick={() => handleImageClick(index)}>
                        ...
                        <TableRow>
                            <TableCell colSpan={7}>
                                <Typography>No medical records found for EmployeeCode {employeeCode1}</Typography>
                            </TableCell>
                        </TableRow>
                    )}
                </TableBody>
