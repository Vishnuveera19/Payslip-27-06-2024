...
import { Grid, Paper, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Box, Divider } from '@mui/material';
...
const PayslipNF = (pnEmployeeId, employeeCode, month, year, dDate) => {
...
async function getData() {
  ...
  const totalsalary =  await postRequest(ServerConfig.url, REPORT, {
    "query": "EXEC FinalSalaryCalculation1 @EmployeeCode = 'EMP001', @Month = 5, @Year = 2024, @D_dates =  '2024-05-01'"});
...
const employeeCode1 = 'EMP001'; 
const empId = pnEmployeeId;
const d_date = '2024-06-01T00:00:00'
...
const employeewtable = employeework.find(emp => emp.pnEmployeeId == empId) 
  ...
  <Grid item xs={3} container direction="column" alignItems="left">
    <Typography variant='h6' align='left'>Roll No.: 0002</Typography>
  ...
  <Grid item xs={3}>
    <Typography variant='h6' align="right">Month of Pay: FEBRUARY 2010</Typography>
